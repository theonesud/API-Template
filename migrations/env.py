...
def run_migrations_offline() -> None:
    ...
    url = config.get_main_option(
        "sqlalchemy.url", f'{os.environ["SQLALCHEMY_DATABASE_URI"]}/{db_name}'
    )
    context.configure(
        url=url,
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            connection=connection, target_metadata=target_metadata, include_object=include_object  # type: ignore
        )
